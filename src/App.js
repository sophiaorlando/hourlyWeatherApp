      ...
      <div id="frontPage">
            ...
            <div className="flip-card">
              <div className="flip-card-inner">
                ...
                <div className="flip-card-back">
                  <div>Sunrise: {hourly.forecast.forecastday[0].astro.sunrise}</div>
                  <div>Moon Phase: {hourly.forecast.forecastday[0].astro.moon_phase}</div>
                  <div>Sunset: {hourly.forecast.forecastday[0].astro.sunset}</div>
                  <div>Chance of Rain: {hourly.forecast.forecastday[0].day.daily_chance_of_rain}%</div>
                  <div>Forecast: {hourly.forecast.forecastday[0].day.condition.text}</div>
        ...
        {(typeof hourly.forecast != "undefined") ? (
          <div className="container-fluid">
            {/* <div className="location-box"> */}
            <h1 id="hourlyHeader">Current Hourly Forecast</h1>
            ...
            <div className="row">
              ...
              <div className="col-sm-6">
            <h1 id="hourlyHeader">Hourly Forecast</h1>
